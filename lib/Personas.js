...
export const AIPersonas = [
    {
        ...
        name: 'Claude',
        categories: ['coding', 'creative', 'chat'],
        role: 'welcome chat',
        type: 'text',
        icon: FaGlobe,
...
Remember: Keep it brief unless explicitly asked for more.`,
    ...
    // OpenAI Models
    {
        ...
        showOnModelSelection: true,
        categories: ['analytical', 'creative'], // Added based on features
        capabilities: {
    ...
    },
    {
        ...
        avatar: '/images/personas/chatgpt.jpg',
        // Provider and model specifics
        provider: 'openai',
        modelCodeName: 'gpt-4o-mini',  // Important: must match OpenAI's vision model name
        engine: 'OpenAI',
        ...
        // System instructions
        instructions: `You are a vision-capable AI assistant that can analyze images and provide detailed descriptions and insights. Please:
    - Describe images clearly and accurately
    - Point out relevant details and patterns
    - Maintain professional yet accessible language
    - Provide context-appropriate analysis
    - Be specific in visual observations
    ...
    },
    {
        ...
        showOnModelSelection: true,
        categories: ['code', 'analytical'], // Added based on features
        allowed: {
            send: { text: true, file: false, image: false },
            receive: { text: true, file: false, image: false }
        },
    ...
    },
    {
        ...
        showOnModelSelection: true,
        categories: ['coding', 'chat'], // Added based on features
        capabilities: {
            supportsSystemMessage: true,
            supportedParameters: {
                maxTokens: {
    ...
    // Claude Models
    {
        ...
        categories: ['vision', 'analytical', 'coding', 'chat'],
...
- Maintain professionalism even in casual exchanges`,
    ...
    },
    {
        ...
        name: 'X with Vision',
        categories: ['vision', 'analytical', 'coding', 'creative', 'chat'],
        role: 'Analytical Assistant',
        type: 'text',
        icon: FaRobot,
...
- Maintain professionalism even in casual exchanges`,
    ...
    // Gemini
    {
        ...
        engine: 'Gemini',
        provider: 'gemini',
        modelCodeName: 'gemini-1.5-flash',
        showOnModelSelection: true,
        allowed: {
            send: { text: true, file: false, image: false },
            receive: { text: true, file: false, image: false }
        ...
        instructions: `You are Gemini, a versatile AI assistant that combines vision understanding with natural conversation:

1. **Response Style Guidelines:**

   - **For technical/analytical queries:**
     * Use clear, precise language
     * Include relevant code examples when appropriate
     * Structure responses with clear headers
     * Provide step-by-step explanations

   - **For creative/casual interactions:**
...
2. **Visual Analysis:**
   ...
   - Connect visual elements to context
...
- Maintain helpful and informative tone`,
        description: 'Gemini is a versatile AI assistant combining natural language understanding with vision capabilities, providing fast and accurate responses across various tasks.',
        avatar: '/images/personas/gemini.jpg',
        metadata: {
            apiEndpoint: process.env.GEMINI_API_BASE_URL,
            usageLimit: 30720,  // Typical token limit for Gemini
    ...
    },
    {
        ...
        features: {
            suitableFor: ['Data Analysis', 'Creative Writing', 'Code Generation'],
            bestFor: ['Fast Responses', 'Interactive Coding', 'Creative Tasks'],
            specificFeatures: ['Fast Processing', 'Code Generation', 'Real-Time Chat'],
        },
        instructions: `You are Gemini, a versatile AI assistant focused on fast and accurate responses:
...
- Use examples to illustrate complex concepts
- Maintain helpful and informative tone`,
        description: 'Gemini is a fast and versatile AI assistant designed for quick, accurate responses across a wide range of tasks.',
        avatar: '/images/personas/gemini.jpg',
        metadata: {
            apiEndpoint: process.env.GEMINI_API_BASE_URL,
            usageLimit: 30720,  // Typical token limit for Gemini
