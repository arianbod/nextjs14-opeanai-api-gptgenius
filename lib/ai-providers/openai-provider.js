...
const formatMessages = ({ persona, previousMessages, fileContent, fileName, fileType }) => {
    try {
        ...
        // Return combined messages, ensuring we always have at least valid messages
        const formattedMessages = [...messages, ...validMessages];
        ...
        // Return a default message if everything fails
        return [{
            role: 'user',
            content: 'Hello'
        }];
